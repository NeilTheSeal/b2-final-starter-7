...
describe Merchant do
  ...
  describe "class methods" do
    before :each do
      ...
      InvoiceItem.create!(invoice: @invoice2, item: @item2, unit_price: 100,
                          quantity: 1, status: 1)
    ...
    it "top_merchants" do
      expect(Merchant.top_merchants).to eq([@merchant6, @merchant5, @merchant4,
                                            @merchant3, @merchant2])
    end
  end
  ...
  describe "instance methods" do
    before :each do
      ...
      @invoice_2 = Invoice.create!(customer_id: @customer_1.id, status: 2,
                                   created_at: "2012-03-26 14:54:09")
      @invoice_3 = Invoice.create!(customer_id: @customer_2.id, status: 2,
                                   created_at: "2012-03-05 14:54:09")
      @invoice_4 = Invoice.create!(customer_id: @customer_3.id, status: 2,
                                   created_at: "2012-03-27 14:54:09")
      @invoice_5 = Invoice.create!(customer_id: @customer_4.id, status: 2,
                                   created_at: "2012-03-04 14:54:09")
      ...
      @transaction7 = Transaction.create!(credit_card_number: 203_942,
                                          result: 1, invoice_id: @invoice_7.id)
      @transaction7 = Transaction.create!(credit_card_number: 203_942,
                                          result: 1, invoice_id: @invoice_8.id)
    ...
    it "can list items ready to ship" do
      expect(@merchant1.ordered_items_to_ship).to eq([@ii_1, @ii_2, @ii_4,
    ...
    it "shows a list of favorite customers" do
      ...
      expect(actual).to eq([@customer_1.first_name, @customer_2.first_name,
                            @customer_3.first_name, @customer_4.first_name, @customer_6.first_name])
    end

    it "top_5_items" do
      expect(@merchant1.top_5_items).to eq([@item_1, @item_2, @item_3, @item_8,
                                            @item_4])
    end
    ...
    it "disabled_items" do
      expect(@merchant1.disabled_items).to eq([@item_2, @item_3, @item_4,
                                               @item_7, @item_8])
      expect(@merchant2.disabled_items).to eq([@item_5, @item_6])
    end

    it "count_active_coupons" do
      expect(@merchant1.count_active_coupons).to eq(2)
    end
  end
end
